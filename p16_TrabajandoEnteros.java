...
public class p16_TrabajandoEnteros {
    public static void main(String[] args) {
        int num1 = 42;
        int num2 = 0x2A; //0x antepuesto para indicar numero hexadecimal
        int num3 = 0b00101010; //0b binario
        byte val1 = 120, val2 = 1;
        short horas = 24, dias = 9099;
        long ganancia = 9223372036854733307L; //Debe llevar la l al final para indicar que es variable tipo long
