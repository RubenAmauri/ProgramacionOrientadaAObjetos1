...
public class App extends JFrame implements ActionListener {
    ...
    public App() {
        ...
        lblDatos = new JLabel("<html>Programación Orientada a Objetos I<br>Carlos Castañeda Ramírez</html>",
                JLabel.CENTER);
        lblDatos.setFont(new Font("Times New Roman", Font.BOLD, 18));
        jdlAcercaDe.add(lblDatos);

        // Configuración de paneles y tabla
        ...
        // Configuración de panel de datos
        pnlDatos = new JPanel();
        add(pnlDatos);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == smnSalir) {
            ...
            if (res == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    datos = Utileria.desSerializarDatos(archivo.getAbsolutePath());
                    cargarDatos();
                } catch (Exception ex) {
            ...
            if (res == JFileChooser.APPROVE_OPTION) {
                File archivo = fchArchivo.getSelectedFile();
                try {
                    Utileria.serializarDatos(archivo.getAbsolutePath(), datos);
