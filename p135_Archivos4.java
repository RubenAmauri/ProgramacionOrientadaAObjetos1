...
public class p135_Archivos4 {
    ...
    public static void capturarDatos(ArrayList<String> datos){
        ...
        System.out.println("Introduce un dato y presiona <Enter>; Dato vacío para terminar");
        while (true) {
            dato = obj.nextLine();
    ...
    public static void mostrarDatos(ArrayList<String> datos){
        System.out.println("\nLos datos hasata el momento son: ");
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Selecciona una opción: "); op = obj.nextInt();
            switch (op) {
                case 1:
                    System.out.println("\nCaptura de datos...");
                    capturarDatos(datos);
